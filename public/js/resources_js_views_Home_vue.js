...
var _hoisted_2 = ["href"];
var _hoisted_3 = {
  "class": "flex-grow text-white p-2"
};
var _hoisted_4 = {
  "class": "w-16 text-gray-300 text-sm p-2"
};
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("main", _hoisted_1, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)(_ctx.$store.state.territories, function (territory) {
    ...
    /* TEXT */
    ), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_4, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(territory.plants), 1
    /* TEXT */
    )], 8
    /* PROPS */
    , _hoisted_2);
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_InformationPanel, {
    path: "/api/plantInfromation"
  }), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Authentication), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("canvas", _hoisted_1, null, 512
  /* NEED_PATCH */
...
/* harmony import */ var _Addons_Actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../Addons/Actions */ "./resources/js/scene/Addons/Actions.js");
...
var _default = /*#__PURE__*/function () {
  function _default(scene) {
    ...
    this.scene = scene;
    this.Actions = new _Addons_Actions__WEBPACK_IMPORTED_MODULE_2__["default"](scene);
    this.Import();
    this.pickidMesh();
  ...
  _createClass(_default, [{
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_1___default().post("/api/territories/getall", {
                  name: name
                });
    ...
    key: "getActiveMeshes",
    value: function () {
      var _getActiveMeshes = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2() {
        var _this3 = this;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 3;
                return axios__WEBPACK_IMPORTED_MODULE_1___default().get('/api/territroy_count');

              case 3:
                _yield$axios$get = _context2.sent;
                data = _yield$axios$get.data;
                this.activeMeshes.forEach(function (mesh) {
                  _this3.meshSceneNames(mesh, data[mesh.name]);
      ...
      function getActiveMeshes() {
        return _getActiveMeshes.apply(this, arguments);
      }
    ...
    key: "meshSceneNames",
    value: function meshSceneNames(mesh, count) {
